    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Rapid3 Studio</li>
            <li className="font-mono text-xs text-foreground/80">Defense Lab</li>
          </ul>
        </div>
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          © 2025 Rapid3. All rights reserved.
        </p>
        <p className="font-mono text-[10px] text-muted-foreground">Engineered for defense. Built with precision.</p>
      </div>
    </section>
  )
}
